...
## About the Project
This is a simple, command-line based Python application designed to help users track their daily expenses. It features an interactive menu that continuously runs until the user decides to exit.

## Features
The application provides a 4-option menu:
...
## Technologies Used
*   Python 3: Core logic, while loops, lists, and dictionaries.

## How to Run
1. Ensure Python is installed on your computer.
2. Save the code in a file named Expense_tracker.py.
3. Open your terminal or command prompt.
4. Run the script using the command: python Expense_tracker.py
5. Follow the on-screen menu prompts to manage your expenses!
